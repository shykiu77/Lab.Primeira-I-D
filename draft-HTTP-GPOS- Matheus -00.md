**Working Group Name**  **Matheus. Lourenco**
...
## 1. Introduction
Esse arquivo é uma versão de extensão do protocolo HTTP, que visa fazer requisições da geolocalização do site (altitude, longitude e latitude)
...
Adicional aos metodos ja existentes no protocolo HTTP, essa extensão inicia com uma requisição GET HTTP, incluindo um campo 'GPOS',
campo este que deve ser preenchido com um 'nome_do_dispositivo', apos executar o protocolo, o servidor retorna uma resposta
no formato: 'nome_dispositivo ttl class GPOS longitude latitude altitude'
